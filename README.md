# IdaPro plugins
* [FLARE Team Reversing Repository (https://github.com/fireeye/flare-ida)](https://github.com/fireeye/flare-ida)
* [HexRaysPyTools (https://github.com/igogo-x86/HexRaysPyTools)](https://github.com/igogo-x86/HexRaysPyTools)
# RE
* [7 Days to Lift: A Mission in Microcode. Extending the Hex-Rays Decompiler to Support Intel AVX Instructions (https://blog.ret2.io/2020/07/22/ida-pro-avx-decompiler/)](https://blog.ret2.io/2020/07/22/ida-pro-avx-decompiler/)
* [Hex-Rays Microcode API против обфусцирующего компилятора (https://forum.reverse4you.org/t/hex-rays-microcode-api/1140)](https://forum.reverse4you.org/t/hex-rays-microcode-api/1140)
* [D810: Creating an extensible deobfuscation plugin for IDA Pro (https://eshard.com/posts/d810_blog_post_1/)](https://eshard.com/posts/d810_blog_post_1/)
* [Linux kernel kallsyms (aarch64) extract (https://github.com/marin-m/vmlinux-to-elf)](https://github.com/marin-m/vmlinux-to-elf)
# IOS
* [ios papers (https://papers.put.as/ios/ios/)](https://papers.put.as/ios/ios/)
...
* [Non-Profiled Deep Learning Side-Channel attacks with Sensitivity Analysis (https://eshard.com/posts/ches2019_post/)](https://eshard.com/posts/ches2019_post/)
# Car hacking
